/**
 * @file Scenery Lua grammar for tree-sitter
 * @author Munif Tanjim/Pandaloop
 * @license MIT
 */

// Adapted version of https://github.com/tree-sitter-grammars/tree-sitter-lua
...
module.exports = grammar({
  ...
  rules: {
    ...
    */
    ...
    // do block end
    do_statement: ($) => seq('do', '{', field('body', optional_block($)), '}'),
    ...
    function_definition: ($) => seq('fn', $._function_body),
    ...
    unary_expression: ($) =>
      prec.left(
        PREC.UNARY,
        seq(choice('!', '#', '-', '~'), field('operand', $.expression))
      ),
